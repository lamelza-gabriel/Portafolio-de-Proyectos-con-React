...
const Tecnologias = () => {
	...
	let initialState = [
		...
		},
		{
			nombre: "css",
			texto:
				"CSS, en español «Hojas de estilo en cascada», es un lenguaje de diseño gráfico para definir y crear la presentación de un documento estructurado escrito en un lenguaje de marcado, como por ejemplo HTML5",
		},
		{
			nombre: "sass",
			texto:
	...
	//ESTADOS
	//textos
	const [tecnologia, setTecnologia] = useState(initialState[0]);
	//Svg focus
	...
	const cambiarTexto = (parametro) => {
		setTecnologia(initialState[parametro]);
	};

	const activarColor = (parametro) => {
		reiniciar();
		parametro(true);
	};
	return (
		<section id='section-tecnologia' className={`tecnologias ${tema}`}>
			<div className='info-text'>
				<h3>Tecnologias Usadas</h3>
				<p>
					Lenguajes y frameworks con los que trabajo para el desarrollo de
					proyectos y aplicaciones web entre otros, ademas de contar con
					conocimientos sobre las principales API de Javascript y React
				</p>
			</div>

			<h4 className={`adv-tecnologias ${tema} `}>
				Puede clickear en los siguientes recuadros para obtener mas informacion
			</h4>
			...
			<div className='icons-container'>
				<div className='icon-container'>
					<h4>HTML5</h4>
					<svg
						className={` icon-tecnologias html  ${
				...
				<div className='icon-container'>
					<h4>CSS</h4>
					<svg
						className={` icon-tecnologias css  ${css ? "active" : "inactive"} `}
						xmlns='http://www.w3.org/2000/svg'
						viewBox='0 0 384 512'
						onClick={() => {
							cambiarTexto(1);
				...
				<div className='icon-container'>
					<h4>SASS</h4>
					<svg
						className={` icon-tecnologias sass  ${
							sass ? "active" : "inactive"
						} `}
						xmlns='http://www.w3.org/2000/svg'
						viewBox='0 0 640 512'
						onClick={() => {
							cambiarTexto(2);
							activarColor(setSass);
						}}
					>
				...
				<div className='icon-container'>
					<h4>JavaScript</h4>
					<svg
						className={` icon-tecnologias javascript  ${
							js ? "active" : "inactive"
						} `}
						xmlns='http://www.w3.org/2000/svg'
						viewBox='0 0 448 512'
				...
				<div className='icon-container'>
					<h4>React</h4>
					<svg
						className={` icon-tecnologias react  ${
							react ? "active" : "inactive"
						} `}
						xmlns='http://www.w3.org/2000/svg'
						viewBox='0 0 512 512'
						onClick={() => {
							cambiarTexto(4);
							activarColor(setReact);
						}}
					>
				...
				<div className='icon-container'>
					<h4>GIT</h4>
					<svg
						className={` icon-tecnologias git  ${git ? "active" : "inactive"} `}
						xmlns='http://www.w3.org/2000/svg'
						viewBox='0 0 448 512'
						onClick={() => {
							cambiarTexto(5);
			...
			<div className='tecnologias-descripcion'>
				<p id='descripcion-tecnologia'>{tecnologia.texto}</p>
			</div>
		</section>
	);
};
